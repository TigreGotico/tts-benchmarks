...
PLUGINS = [
    ...
    ("ovos-tts-plugin-pico", PicoTTS(config={}), None, ["fr"]),
    ("ovos-tts-plugin-google-tx", GoogleTranslateTTS(config={}), None, ["fr"]),
    ("ovos-tts-plugin-espeak", EspeakNGTTS(config={}), None, ["fr"])
]
