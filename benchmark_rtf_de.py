...
db = JsonStorage("benchmark_tts_de.json")
...
PLUGINS = [
    ...
    ("ovos-tts-plugin-pico", PicoTTS(config={}), None, ["de"]),
    ("ovos-tts-plugin-google-tx", GoogleTranslateTTS(config={}), None, ["de"]),
    ("ovos-tts-plugin-espeak", EspeakNGTTS(config={}), None, ["de"])
]
