...
PLUGINS = [
    ...
    ("ovos-tts-plugin-edge-tts", EdgeTTSPlugin(config={}), 'ca-ES-JoanaNeural', ["ca"]),
    ("ovos-tts-plugin-edge-tts", EdgeTTSPlugin(config={}), 'ca-ES-EnricNeural', ["ca"]),
    ("ovos-tts-plugin-google-tx", GoogleTranslateTTS(config={}), None, ["ca"]),
    ("ovos-tts-plugin-espeak", EspeakNGTTS(config={}), None, ["ca"]),
